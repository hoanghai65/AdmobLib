...
public class RewardedModel extends RewardAbstract{
        ...
        if (GoogleMobileAdsConsentManager.getInstance(activity).getConsentResult(activity)) {
            ...
            RewardedAd.load(activity, AD_UNIT_ID, adRequest, new RewardedAdLoadCallback() {
                ...
                public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                    ...
                    mRewarded.setFullScreenContentCallback(getfullScreenContentCallback(activity));
        ...
        if (mRewarded != null ) {
            ...
            if (!adIsLoading) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mRewarded.show(activity, new OnUserEarnedRewardListener() {
                            @Override
