...
public class AdsParamUtils extends AdUnitFactory {
    ...
    public int getIntervalBetweenInterstitial() {
        Log.e("AppConfigs", "getIntervalBetweenInterstitial: Fuckkk 9"  );
    return AppConfigs.getInt(RemoteKey.INTERVAL_BETWEEN_INTERSTITIAL);
    }

    @Override
    public int getInterstitialFromStart() {
        return AppConfigs.getInt(RemoteKey.INTERSTITIAL_FROM_START);
    }

    @Override
    public String getRateAoaInterSplash() {
        return AppConfigs.getString(RemoteKey.RATE_AOA_INTER_SPLASH);
    }
